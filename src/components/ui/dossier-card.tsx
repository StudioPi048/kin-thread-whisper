...
> = {
  active: {
    label: "ATIVO",
    ariaLabel: "Em acompanhamento clínico",
    color: "var(--material-stamp-fg, #1B3D2D)",
    rotation: -3,
  },
  archived: {
    label: "ARQUIVO",
    ariaLabel: "Dossiê arquivado",
    color: "var(--material-stamp-arc, #8B6914)",
    rotation: 3,
  },
};
          ...
          >
            ...
            <span
              aria-label={
                consentStatus === "signed"
                  ...
                  : "Consentimento pendente ou ausente"
              }
              style={{
                fontSize: "10.5px",
                fontFamily: "var(--font-sans)",
            ...
            >
              {consentStatus === "signed" ? (
                ...
                <>
                  <AlertTriangle style={{ width: "11px", height: "11px" }} aria-hidden /> Sem
                  consentimento
                </>
              )}
            </span>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLButtonElement).style.color =
                  "var(--material-gold, #C6A23A)")
              }
              onMouseLeave={(e) =>
                ((e.currentTarget as HTMLButtonElement).style.color = "var(--forest, #12291F)")
              }
            >
              Abrir →
            </button>
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="icon-sm"
          className={
            compact ? "size-6 opacity-40 hover:opacity-100" : "size-7 opacity-40 hover:opacity-100"
          }
          aria-label={`Ações para o dossiê de ${patientName}`}
        >
          <MoreHorizontal
            style={{ width: compact ? "12px" : "13px", height: compact ? "12px" : "13px" }}
          />
        </Button>
      </DropdownMenuTrigger>
        ...
        <div style={{ padding: "13px 14px", display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          {variant === "full" && (
            <div style={{ marginTop: "8px" }}>
              <div
                className="skeleton"
                style={{ height: "12px", width: "100%", borderRadius: "4px", marginBottom: "5px" }}
              />
              <div
                className="skeleton"
                style={{ height: "12px", width: "65%", borderRadius: "4px" }}
              />
            </div>
          )}
        </div>
