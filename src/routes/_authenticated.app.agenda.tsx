...
const FALLBACK_SESSIONS: Session[] = [
  {
    ...
    daysSinceFirst: 28,
    lastEvolution: "Exemplo de evolução clínica anterior.",
    seals: ["retorno", "aniversario", "projeto"],
    aiAlerts: [
      "Exemplo de alerta clínico gerado pela IA.",
      "Exemplo de padrão transgeracional identificado.",
      "Exemplo de pendência no genossociograma.",
    ],
  ...
  },
  {
    ...
    seals: ["retorno", "luto"],
    aiAlerts: [
      "Exemplo de orientação para primeira escuta.",
      "Exemplo de padrão preliminar detectado.",
    ],
  ...
  },
  {
    ...
    aiAlerts: [
      "Exemplo: cliente nova, dados familiares pendentes.",
      "Exemplo: sugerido abrir estrutura base do genossociograma.",
    ],
