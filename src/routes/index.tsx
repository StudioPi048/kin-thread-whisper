          ...
          <nav style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
            ...
            <Link
              ...
              style={{
                ...
                border: "1.5px solid #3B2F2F", borderRadius: "999px", padding: "10px 24px", textDecoration: "none",
                transition: "all 0.2s",
              }}
            >
              Acesso beta →
      ...
      <section style={{ display: "flex", minHeight: "100vh", paddingTop: "68px", background: "#1B211A" }}>
        ...
        <div style={{ maxWidth: "440px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "28px" }}>
              <ShieldCheck style={{ width: "20px", height: "20px", color: "#D4AF37", flexShrink: 0 }} strokeWidth={1} />
              <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#D4AF37" }}>
                Ética & LGPD
              </span>
            </div>

            {/* H1 */}
            <h1 style={{ fontSize: "clamp(2.8rem, 5vw, 4.2rem)", fontWeight: 700, lineHeight: 1.06, letterSpacing: "-0.01em", color: "#fff", margin: "0 0 28px" }}>
              Dados clínicos são{" "}
            ...
            <p style={{ fontSize: "22px", lineHeight: 1.8, color: "rgba(255,255,255,0.75)", marginBottom: "36px", fontFamily: "'Cormorant Garamond', serif" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
              <Link
                ...
                style={{
                  ...
                  padding: "18px 36px", borderRadius: "2px", textDecoration: "none",
              ...
              <button style={{ display: "flex", alignItems: "center", gap: "10px", background: "none", border: "none", cursor: "pointer", fontFamily: "'Outfit', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.75)", padding: 0 }}>
                <PlayCircle style={{ width: "24px", height: "24px", color: "#D4AF37" }} strokeWidth={1} />
                Ver como funciona
              </button>
            </div>
          </div>
        ...
        <div style={{ flex: "0 0 58%", position: "relative", overflow: "hidden", minHeight: "600px" }}>
          ...
          <div style={{
            ...
            padding: "24px 28px", width: "220px",
            transform: "rotate(7deg)", boxShadow: "0 12px 40px rgba(0,0,0,0.3)",
            zIndex: 10,
          }}>
            <div style={{ position: "absolute", top: "-12px", left: "50%", transform: "translateX(-50%)" }}>
              <Tape rotate="-1deg" w="72px" />
            </div>
            <p style={{ fontSize: "19px", fontStyle: "italic", color: "#3B2F2F", lineHeight: 1.55, textAlign: "center", margin: 0, fontWeight: 500 }}>
      ...
      <section style={{ position: "relative", zIndex: 20, marginTop: "40px", padding: "0 24px 0" }}>
        <div className="container-liz" style={{ maxWidth: "1120px" }}>
          <div style={{
            ...
            {/* Esquerda — "03" + título */}
            <div style={{ flex: "0 0 38%", background: "#151A15", padding: "56px 48px", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              {/* Número decorativo GRANDE */}
              <span style={{
                position: "absolute", left: "16px", top: "16px",
                fontFamily: "'Cormorant Garamond', serif", fontSize: "140px", fontWeight: 700,
                color: "rgba(212,175,55,0.06)", lineHeight: 1, userSelect: "none", pointerEvents: "none",
              }}>
                03
              </span>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#D4AF37", marginBottom: "20px", position: "relative", zIndex: 1 }}>
                Pilares da plataforma
              </p>
              <h2 style={{ fontSize: "clamp(1.8rem,2.8vw,2.4rem)", fontWeight: 700, color: "#fff", lineHeight: 1.25, margin: 0, position: "relative", zIndex: 1 }}>
        ...
        <div className="container-liz" style={{ maxWidth: "1120px" }}>
          <div style={{
            ...
            <div style={{ flex: 1, color: "#fff", minWidth: 0 }}>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#D4AF37", marginBottom: "20px" }}>
                O fio invisível da sessão
              </p>
              <h3 style={{ fontSize: "clamp(1.7rem, 3vw, 2.3rem)", fontWeight: 700, color: "#fff", lineHeight: 1.15, marginBottom: "20px", wordBreak: "break-word" }}>
                Conecte gerações, com <em style={{ fontStyle: "italic", color: "#D4AF37" }}>profundidade</em> e leveza.
              </h3>
              <p style={{ fontSize: "20px", lineHeight: 1.8, color: "rgba(255,255,255,0.62)", marginBottom: "28px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {["Genograma dinâmico gerado no clique", "Foco absoluto no paciente", "Menos papel, mais insight estruturado"].map(item => (
                  <p key={item} style={{ fontSize: "19px", fontStyle: "italic", color: "rgba(212,175,55,0.8)", margin: 0 }}>✓ {item}</p>
                ))}
              </div>
            </div>
      ...
      <footer style={{ background: "#1B211A", borderTop: "3px solid #D4AF37", paddingTop: "64px", paddingBottom: "32px" }}>
        <div className="container-liz" style={{ display: "flex", flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", gap: "32px", flexWrap: "wrap" }}>
          ...
          <div style={{ color: "#fff", maxWidth: "380px" }}>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "16px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#D4AF37", marginBottom: "16px" }}>
              Beta Fechado · 2026
            </p>
            <h2 style={{ fontSize: "clamp(2.1rem, 3.5vw, 3rem)", fontWeight: 700, color: "#fff", lineHeight: 1.15, marginBottom: "16px" }}>
              Pronta para{" "}
