        ...
        <main className="flex-1 min-w-0 space-y-24">
          ...
          <section className="relative pt-6">
            <div className="relative z-10 flex items-start gap-4 md:gap-6">
              <span
                aria-hidden
                className="hidden md:block font-serif text-6xl lg:text-7xl italic font-bold text-white/5 leading-none select-none shrink-0 pt-2"
              >
                01
              </span>
              <div className="min-w-0 flex-1 space-y-3">
                <p className="font-sans text-[16px] font-bold uppercase tracking-[0.2em] text-[#D4AF37]">
                  Hub de Inteligência Clínica
                </p>
                <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold leading-[0.95] text-white">
                  Biblioteca <span className="italic font-medium text-[#D4AF37]">Clínica</span>
                </h1>
                <p className="max-w-2xl font-serif text-[18px] italic leading-relaxed text-white/70">
            ...
            <div className="relative z-10 space-y-6 mt-8">
              ...
              <div className="group relative max-w-3xl">
                <div className="absolute inset-0 bg-[#D4AF37]/5 blur-xl opacity-60 group-focus-within:opacity-100 transition-opacity duration-500" />
                <div className="relative flex items-center gap-3 bg-[#151A15] border border-white/10 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.8)] p-2 pl-5">
                  ...
                  <input
                    ...
                    className="flex-1 min-w-0 border-none bg-transparent py-4 font-serif text-[17px] text-white placeholder:text-white/30 italic focus:outline-none"
                  />
                  <kbd className="hidden md:inline-flex items-center gap-1 border border-white/20 bg-white/5 px-2 py-1 font-sans text-[16px] font-bold text-white/60 uppercase tracking-widest">
                    ⌘K
                  </kbd>
                  <button className="hidden sm:inline-flex items-center gap-2 bg-[#D4AF37] hover:bg-[#D4AF37]/80 px-6 py-4 font-sans text-[16px] font-bold uppercase tracking-widest text-[#1B211A] transition-colors">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <span className="font-sans text-[16px] font-bold uppercase tracking-widest text-white/50 mr-2">
                  Sugestões:
                </span>
                {QUICK_SUGGESTIONS.map((s) => (
                  <button
                    key={s}
                    onClick={() => setQ(s)}
                    className="border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-2 font-sans text-[16px] font-bold uppercase tracking-widest text-white/80 transition-colors shadow-sm"
                  >
                    {s}
                  </button>
                ))}
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-5 auto-rows-[minmax(180px,auto)]">
              {/* Concept of day — big */}
              <div className="col-span-4 md:col-span-2 md:row-span-2 relative overflow-hidden border-l-4 border-l-[#D4AF37] bg-[#151A15] border border-white/10 shadow-xl p-8 flex flex-col justify-between group">
                <div className="absolute -right-6 -top-2 font-serif text-[180px] italic leading-none text-white/5 select-none">
                  {TODAY.concept.title.charAt(0)}
                </div>
                <div className="relative space-y-4">
                  <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37]">
                    <Sparkles className="size-3" /> {TODAY.concept.label}
                  </div>
                  <h3 className="font-serif text-4xl md:text-5xl font-bold italic leading-tight text-white">
                    {TODAY.concept.title}
                  </h3>
                  <p className="max-w-md font-serif text-[17px] leading-relaxed text-white/70 italic">
                    {TODAY.concept.body}
                  </p>
                </div>
                <div className="relative flex flex-wrap items-center justify-between gap-4 mt-8">
                  <div className="flex flex-wrap gap-2">
                    {TODAY.concept.related.map((r) => (
                      <span
                        key={r}
                        className="bg-white/5 px-3 py-1.5 font-sans text-[16px] font-bold uppercase tracking-widest text-white/60"
                      >
                        {r}
                      </span>
                    ))}
                  </div>
                  <button className="inline-flex items-center gap-2 font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37] hover:gap-3 transition-all">
              ...
              {/* Author of week */}
              <div className="col-span-4 md:col-span-2 bg-[#151A15] shadow-[0_16px_40px_rgba(0,0,0,0.4)] p-8 flex items-center gap-6">
                <div className="flex size-24 shrink-0 items-center justify-center bg-[#151A15] border border-black/10 text-white font-serif text-3xl font-bold shadow-xl">
                  {TODAY.authorOfWeek.initials}
                </div>
                <div className="min-w-0">
                  <p className="font-sans text-[16px] font-bold uppercase tracking-[0.2em] text-[#1B211A]/50">
                    Autor da semana
                  </p>
                  <h4 className="font-serif text-3xl font-bold leading-tight mt-2 text-[#1B211A]">
                    {TODAY.authorOfWeek.name}
                  </h4>
                  <p className="font-sans text-[16px] font-bold uppercase tracking-widest text-[#1B211A]/70 mt-2">
              ...
              {/* Recommended book */}
              <div className="col-span-2 md:col-span-1 bg-[#151A15] border border-white/10 p-6 flex flex-col justify-between shadow-xl">
                <div>
                  <p className="font-sans text-[16px] font-bold uppercase tracking-[0.2em] text-[#D4AF37]">
                    Livro recomendado
                  </p>
                  <h4 className="mt-3 font-serif text-[22px] font-bold text-white italic leading-tight">
                    {TODAY.bookRecommended.title}
                  </h4>
                  <p className="font-sans text-[16px] font-bold uppercase tracking-widest text-white/50 mt-2">
                    {TODAY.bookRecommended.author}
                  </p>
                </div>
                <span className="mt-4 self-start bg-white/5 border border-[#D4AF37]/30 px-3 py-1 font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37]">
                  {TODAY.bookRecommended.tag}
                </span>
              </div>

              {/* Clinical question */}
              <div className="col-span-2 md:col-span-1 bg-[#151A15] border border-black/5 shadow-lg p-6 flex flex-col justify-between">
                <p className="font-sans text-[16px] font-bold uppercase tracking-[0.2em] text-[#1B211A]/50">
                  Pergunta clínica
                </p>
                <p className="text-[17px] font-serif italic leading-relaxed text-[#1B211A] mt-4 font-medium">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {ESSENTIAL_BOOKS.map((b) => (
                <article
                  key={b.title}
                  className="group relative flex gap-5 bg-[#151A15] border border-white/10 p-5 shadow-sm hover:shadow-xl hover:border-white/20 transition-all duration-500 hover:-translate-y-1"
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <h3 className="font-serif text-[22px] font-bold text-white leading-tight">
                          {b.title}
                        </h3>
                        <p className="font-serif text-[16px] italic text-white/50 mt-1 leading-snug">
                          {b.subtitle}
                        </p>
                        <p className="font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37] mt-3">
                          {b.author} · {b.year}
                        </p>
                      </div>
                      <span className="shrink-0 bg-white/5 border border-white/10 px-3 py-1.5 font-sans text-[16px] font-bold uppercase tracking-widest text-white/70">
                        {b.level}
                      </span>
                    </div>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {b.concepts.map((c) => (
                        <span
                          key={c}
                          className="bg-white/5 px-2.5 py-1.5 font-sans text-[16px] font-bold uppercase tracking-widest text-white/60"
                        >
                          {c}
                        </span>
                      ))}
                    ...
                    <div className="mt-auto pt-4 border-t border-white/10 flex items-center justify-between">
                      <div className="flex items-center gap-4 font-sans text-[16px] font-bold uppercase tracking-widest text-white/40">
                        <span>
                          <strong className="text-white/80">{b.citations}</strong> citações
                        </span>
                        <span>
                          <strong className="text-white/80">{b.protocols}</strong> protocolos
                        </span>
                        <span>
                          <strong className="text-white/80">{b.cases}</strong> casos
                        </span>
                      </div>
                      <button className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 font-sans text-[16px] font-bold uppercase tracking-widest text-white hover:bg-[#D4AF37] hover:text-[#1B211A] transition-colors">
                        Abrir
                      </button>
                    </div>
                  </div>
          ...
          <section className="space-y-6">
            ...
            <div className="columns-1 md:columns-2 xl:columns-3 gap-5 [column-fill:_balance]">
              {QUOTES.map((q, i) => {
                const bg =
                  q.tone === "mahogany"
                    ? "bg-[#151A15] text-[#1B211A] shadow-[0_16px_40px_rgba(0,0,0,0.4)]"
                    : q.tone === "gold"
                      ? "bg-[#D4AF37] text-[#1B211A]"
                      : q.tone === "forest"
                        ? "bg-[#1B211A] text-[#FAFAF8] border border-white/10"
                        : "bg-[#151A15] text-[#FAFAF8] border border-white/10";
                const authorColor =
                  q.tone === "mahogany" ? "text-[#151A15]/60" : q.tone === "gold" ? "text-[#151A15]/60" : "text-[#D4AF37]";
                const iconColor =
                  q.tone === "mahogany" ? "text-[#151A15]/10" : q.tone === "gold" ? "text-[#151A15]/20" : "text-white/10";
                return (
                  <figure
                    key={i}
                      ...
                      <div>
                        ...
                        <p
                          className={`font-sans text-[16px] uppercase tracking-widest mt-1 ${
                            q.tone === "mahogany" || q.tone === "gold" ? "text-[#151A15]/40" : "text-white/40"
                          }`}
                        >
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {PROTOCOLS.map((p) => (
                <article
                  key={p.title}
                  className={`group bg-[#151A15] border border-white/10 p-6 shadow-xl transition-all ${p.accent.replace("border-l-gold", "border-l-4 border-l-[#D4AF37]").replace("border-l-forest", "border-l-4 border-l-[#FAFAF8]").replace("border-l-mahogany", "border-l-4 border-l-white/20")}`}
                >
                  <div className="flex items-center justify-between mb-4">
                    <span className="inline-flex items-center gap-2 bg-white/5 px-3 py-1 font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37]">
                      ...
                      {[1, 2, 3].map((n) => (
                        <span
                          ...
                          className={`size-1.5 rounded-full ${
                            n <= p.complexity ? "bg-[#D4AF37]" : "bg-white/10"
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  <p className="mt-3 font-serif text-[16px] italic text-white/70 leading-relaxed">{p.goal}</p>

                  <div className="mt-5 border-l border-[#D4AF37]/50 pl-4 py-1">
                    <p className="font-sans text-[9px] font-bold uppercase tracking-[0.2em] text-[#D4AF37] mb-1">
                      Indicação
                    </p>
                    <p className="font-serif text-[16px] text-white/80">{p.indication}</p>
                  </div>

                  <ol className="mt-6 space-y-3">
                    {p.steps.map((s, i) => (
                      <li key={s} className="flex items-start gap-3 text-[16px] text-white/80 font-serif">
                        <span className="mt-1 flex size-5 shrink-0 items-center justify-center border border-white/20 font-sans text-[9px] font-bold text-white/60">
                          {i + 1}
                        </span>
                        <span>{s}</span>
                      </li>
                  ...
                  <div className="mt-8 flex gap-3 border-t border-white/10 pt-5">
                    <button className="flex-1 inline-flex items-center justify-center gap-2 bg-[#D4AF37] hover:bg-[#D4AF37]/80 py-3 font-sans text-[16px] font-bold uppercase tracking-widest text-[#1B211A] transition-colors">
                      <ScrollText className="size-4" /> Checklist
                    </button>
                    <button className="inline-flex items-center justify-center border border-white/20 bg-white/5 hover:bg-white/10 px-4 text-white transition-colors">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredEntries.map((e) => (
                  <motion.article
                    ...
                    className="bg-[#151A15] border border-white/10 p-6 hover:border-white/30 transition-all shadow-lg"
                  >
                    <div className="flex items-baseline justify-between gap-3">
                      <h4 className="font-serif text-[18px] font-bold text-white">{e.author}</h4>
                      {e.school && (
                        <span className="font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37]">
                          {e.school}
                        </span>
                      )}
                    </div>
                    <p className="mt-2 font-serif text-[16px] italic font-semibold text-white/80">
                      {e.title}
                      {e.topic && (
                        <span className="font-normal text-white/50"> — {e.topic}</span>
                      )}
                    </p>
                    {e.summary && (
                      <p className="mt-3 font-serif text-[16px] leading-relaxed text-white/60 line-clamp-3">
                        {e.summary}
                      </p>
                    )}
                    {e.tags && e.tags.length > 0 && (
                      <div className="mt-4 flex flex-wrap gap-2">
                        {e.tags.slice(0, 4).map((t) => (
                          <span
                            key={t}
                            className="bg-white/5 px-2.5 py-1 font-sans text-[9px] font-bold uppercase tracking-widest text-white/50 border border-white/10"
                          >
                            {t}
                          </span>
                        ))}
  ...
  return (
    <div className="flex items-end justify-between gap-4 border-b border-white/10 pb-4">
      <div className="flex items-end gap-5 min-w-0">
        <span className="font-serif text-4xl md:text-5xl italic font-bold text-white/10 leading-none select-none shrink-0">
          {number}
        </span>
        <div className="min-w-0">
          ...
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-white leading-tight mt-1">
            {title}
          </h2>
        </div>
      </div>
      {action && (
        <button
          ...
          className="shrink-0 inline-flex items-center gap-1.5 font-sans text-[16px] font-bold uppercase tracking-widest text-white/50 hover:text-white transition-colors"
        >
...
function GlossaryRow({
  ...
  return (
    <button
      onClick={onOpen}
      className="group w-full text-left flex items-start gap-5 p-5 hover:bg-white/5 transition-colors border-b border-black/5"
    >
      <div className="flex size-12 shrink-0 items-center justify-center bg-[#151A15] border border-black/10 text-white group-hover:bg-[#D4AF37] group-hover:text-[#1B211A] transition-colors">
        <Icon className="size-5" />
      </div>
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-2">
          <h4 className="font-serif text-[18px] font-bold text-[#1B211A] leading-tight">{item.term}</h4>
          <ChevronRight className="size-4 text-black/20 group-hover:text-[#1B211A] group-hover:translate-x-1 transition-all shrink-0" />
        </div>
        <p className="mt-1 font-serif text-[16px] text-[#1B211A]/60 italic leading-snug line-clamp-1">
          {item.short}
        </p>
      </div>
    </button>
    ...
    <div>
      <div className="block-mahogany p-8 relative overflow-hidden">
        ...
        <SheetHeader className="relative z-10 space-y-4 p-0">
          ...
          <p className="text-[16px] leading-relaxed text-white/80 text-left">{item.short}</p>
        </SheetHeader>
      </div>
      ...
      <div className="p-8 space-y-8">
        ...
        <DetailBlock label="Conceitos relacionados">
          <div className="flex flex-wrap gap-2">
            {item.related.map((r) => (
              <span
                key={r}
                className="inline-flex items-center gap-1 rounded-md border border-mahogany/15 bg-white px-2.5 py-1 text-[16px] font-medium text-mahogany hover:bg-mahogany hover:text-white transition-colors cursor-pointer"
              >
        ...
        <button className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-mahogany py-3 text-[16px] font-bold uppercase tracking-wider text-white hover:bg-forest transition-colors">
    ...
    <aside className="relative shrink-0 hidden xl:block transition-all duration-300">
      ...
      <AnimatePresence initial={false} mode="wait">
        {open ? (
          ...
          >
            <div className="relative overflow-hidden bg-[#151A15] border border-white/20 p-6 text-white shadow-xl">
              <div className="absolute -right-6 -top-6 size-32 rounded-full bg-[#D4AF37]/10 blur-3xl" />
              <div className="relative">
                <div className="flex items-center gap-4">
                  <div className="flex size-10 items-center justify-center border border-[#D4AF37]/50 bg-[#D4AF37]/10">
                    <BrainCircuit className="size-5 text-[#D4AF37]" />
                  </div>
                  <div>
                    <h3 className="font-serif text-[18px] font-bold">IA Clínica</h3>
                    <p className="font-sans text-[9px] uppercase tracking-[0.2em] text-[#D4AF37] font-bold">
                      Contextual · viva
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-[#1B211A] border border-[#D4AF37]/20 p-6 shadow-md">
              <p className="font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37]">
                Curiosidade histórica
              </p>
              <p className="mt-3 text-[16px] leading-relaxed text-white/80 italic font-serif">
                {TODAY.historyBite}
              </p>
            </div>

            {/* Mini timeline */}
            <div className="bg-[#151A15] border border-white/10 p-6 shadow-sm">
              <p className="font-sans text-[16px] font-bold uppercase tracking-widest text-white/50">
                Linha do tempo
              </p>
              <ol className="mt-4 space-y-4">
                {[
                  ...
                  <li key={t.y} className="flex items-start gap-3 text-[16px]">
                    <span className="mt-0.5 border border-[#D4AF37]/30 bg-[#1B211A] px-2 py-0.5 font-sans font-bold text-[#D4AF37] text-[16px]">
                      {t.y}
                    </span>
                    <span className="text-white/70 leading-snug font-serif italic">{t.e}</span>
                  </li>
                ))}
              </ol>
            </div>
          ...
          <motion.div
            ...
            exit={{ width: 0, opacity: 0 }}
            className="w-12 sticky top-6 flex flex-col items-center gap-4 bg-[#151A15] border border-white/10 py-6 shadow-sm cursor-pointer"
            onClick={onToggle}
          >
            <BrainCircuit className="size-5 text-[#D4AF37] animate-pulse" />
            <p
              className="font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37]/80"
...
function AiBlock({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="rounded-lg bg-white/5 border border-white/10 p-3">
      ...
      <p className="text-[16px] leading-relaxed text-white/85">{children}</p>
    </div>
  );
}
...
function AuthorPortraitCard({
  ...
  return (
    <button className="group text-left">
      <div className="relative aspect-[4/5] overflow-hidden bg-[#151A15]">
        {/* Museum paper grain */}
        <div
          aria-hidden
        ...
        <SmartImage
          ...
          fallback={
            <div className="absolute inset-0 flex items-center justify-center">
              <span
                className="font-serif text-[68px] font-black italic text-[#1B211A]/20 select-none"
        ...
        <div className="absolute inset-x-0 bottom-0 p-3">
          {author.years && (
            <p className="font-sans text-[9px] font-bold uppercase tracking-[0.25em] text-[#D4AF37]">
              {author.years}
            </p>
          )}
          <p className="mt-0.5 font-sans text-[16px] text-white/50 font-bold uppercase tracking-widest">{author.nationality ?? ""}</p>
        </div>
        {featured && (
          <span className="absolute top-3 right-3 bg-[#D4AF37] px-2 py-0.5 font-sans text-[8px] font-black uppercase tracking-widest text-[#1B211A] shadow-md">
            Semana
          </span>
        )}
      </div>
      <div>
        <h4 className="font-serif text-[17px] font-bold text-white leading-tight">
          {author.name}
        </h4>
        <p className="mt-1 font-sans text-[16px] uppercase tracking-widest text-[#D4AF37] font-bold">
          {author.field}
        </p>
        <p className="mt-1 font-sans text-[16px] text-white/40 uppercase tracking-widest font-bold">
  ...
  return (
    <section className="relative space-y-8">
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 items-stretch">
        {/* Portrait */}
        <div className="relative">
          <div className="relative aspect-[4/5] overflow-hidden border border-black/30 shadow-[0_30px_80px_rgba(0,0,0,0.8)] ring-1 ring-white/10 bg-[#151A15]">
            <img
              src={LETICIA.photo}
              alt={LETICIA.name}
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#151A15] via-[#151A15]/70 to-transparent p-6">
              <p className="font-sans text-[9px] font-bold uppercase tracking-[0.3em] text-[#D4AF37]">
            ...
            <span className="absolute top-4 left-4 inline-flex items-center gap-1.5 bg-[#D4AF37] px-3 py-1 font-sans text-[9px] font-black uppercase tracking-widest text-[#1B211A] shadow-md">
              <Sparkles className="size-3 text-[#1B211A]" /> Coleção autoral
            </span>
          </div>
        </div>

        {/* Bio + counters */}
        <div className="flex flex-col justify-between bg-[#151A15] border border-white/10 p-8 shadow-xl">
          <div className="space-y-5">
            <p className="font-sans text-[16px] font-bold uppercase tracking-[0.28em] text-[#D4AF37]">
              Biblioteca Autoral
            </p>
            <h3 className="font-serif text-2xl md:text-3xl font-bold text-white leading-[1.1]">
              Toda a produção científica, clínica e didática da{" "}
              <span className="italic text-[#D4AF37]">fundadora</span> da Academia.
            </h3>
            <p className="font-serif text-[16px] leading-relaxed text-white/70 max-w-xl">
              {LETICIA.bio}
            </p>
          </div>
          <div className="mt-8 grid grid-cols-3 gap-3 border-t border-white/10 pt-6">
            {[
              ...
              <div key={s.l} className="min-w-0">
                ...
                <p className="font-sans text-[16px] font-bold uppercase tracking-[0.1em] text-white/40 mt-2">
                  {s.l}
                </p>
              </div>
            ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {LETICIA_WORKS.map((w) => (
          <article
            key={w.title}
            className="group relative overflow-hidden bg-[#151A15] border border-white/10 shadow-lg hover:shadow-2xl hover:border-[#D4AF37]/50 hover:-translate-y-1 transition-all duration-500"
          >
            {/* Cover panel */}
            <div
              className={`relative h-44 flex items-center justify-center overflow-hidden bg-[#1B211A] text-white`}
            >
              {/* Letícia portrait medallion */}
              <div className="absolute -bottom-6 -right-6 size-32 rounded-full overflow-hidden border-4 border-white/10 opacity-30 group-hover:opacity-60 transition-opacity">
                <img
                  src={LETICIA.photo}
                  alt=""
                  aria-hidden
              ...
              <div className="relative z-10 text-center px-6">
                <p className="font-sans text-[16px] font-bold uppercase tracking-[0.3em] opacity-70 text-[#D4AF37]">
                  {w.kind}
                </p>
              ...
              {/* Badge */}
              <span
                className={`absolute top-3 left-3 px-3 py-1 font-sans text-[9px] font-black uppercase tracking-widest shadow border border-[#D4AF37]/30 ${
                  w.badge === "Novo"
                    ? "bg-[#D4AF37] text-[#1B211A]"
                    : w.badge === "Exclusivo"
                      ? "bg-[#151A15] text-[#D4AF37]"
                      : w.badge === "Mais estudado"
                        ? "bg-[#151A15] text-[#1B211A]"
            ...
            {/* Meta */}
            <div className="p-6 space-y-4 bg-[#1B211A]">
              <p className="font-serif text-[16px] italic text-white/70 leading-snug">
                {w.subtitle}
              </p>
              <div className="flex items-center justify-between font-sans text-[16px] font-bold uppercase tracking-widest text-white/50 border-t border-white/10 pt-4">
                <span>
                  <strong className="text-white">{w.concepts}</strong> conceitos
                </span>
                <span>
                  <strong className="text-white">{w.protocols}</strong> protocolos
                </span>
                <span>
                  <strong className="text-white">{w.citations}</strong> citações
                </span>
              </div>
              <button className="w-full inline-flex items-center justify-center gap-2 border border-[#D4AF37] py-3 font-sans text-[16px] font-bold uppercase tracking-widest text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#1B211A] transition-colors">
